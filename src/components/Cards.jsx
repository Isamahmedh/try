  ...
  return (
    <div className='w-full py-[10rem] px-4 text-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 bg-[#000300]'>
              ...
              <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Watch Detail</button>
          </div>
          <div className=' bg-fixed w-full shadow-xl bg-[#000300] flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
