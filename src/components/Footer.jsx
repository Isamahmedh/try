...
import {
  ...
  const Footer = () => {
    return (
      <div className='bg-[#000300] border-t-2 mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        <div>
          <h1 className='w-full text-3xl font-bold text-[#00df9a]'>Efoyta.</h1>
          <p className='py-4'>Prioritize your well-being with us! Experience personalized care and convenience at every doctor's appointment. Your health journey starts here - schedule your wellness with confidence and ease.</p>
