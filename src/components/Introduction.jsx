  ...
  return (
    <div className='text-white lg:inline-flex'>
      ...
      <div className='flex w-auto sm:justify-center justify-end max-w-[700px] ml-2'>
        <img className='hidden md:block xl:max-w-[350px] w-auto lg:max-w-[250px] md:max-w-[400px] sm:max-w-[200px] h-auto m-2 rounded-xl ease-in-out duration-300 hover:scale-110 brightness-90 hover:brightness-110' src={manSurgeon} alt='/' />
